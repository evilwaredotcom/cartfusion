...
<cfscript>
	getFeaturedProducts = application.Queries.getFeaturedProducts(
		SiteID=application.SiteID,
		Price=session.CustomerArray[28]);
</cfscript>
	...
	<cfif getFeaturedProducts.RecordCount>
		...
		<cfloop query="getFeaturedProducts">
			<div class="featuredItem">
				<a href="ProductDetail.cfm?ItemID=#ItemID#"><img src="#application.ImagePath#/#ImageDir#/#ImageSmall#" width="75" alt="#ItemName#" /></a>
