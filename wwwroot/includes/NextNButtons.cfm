...
<!--- OLD
<cfoutput>
	<a href="#CGI.SCRIPT_NAME#?StartRow=1&SortOption=#SortOption#&SortAscending=#SortAscending#<cfif isDefined('field')>&field=#field#&string=#string#</cfif><cfif isDefined('URL.CatDisplay')>&CatDisplay=#CatDisplay#<cfelseif isDefined('URL.SecDisplay')>&SecDisplay=#SecDisplay#</cfif><cfif isDefined('URL.CatFilter')>&CatFilter=#CatFilter#<cfelseif isDefined('URL.SecFilter')>&SecFilter=#SecFilter#</cfif><cfif isDefined('SMC') AND SMC NEQ ''>&SMC=#URLEncodedFormat(SMC)#<cfelseif isDefined('SMS') AND SMS NEQ ''>&SMS=#URLEncodedFormat(SMS)#</cfif><cfif isDefined('URL.ShowRows')>&ShowRows=#URL.ShowRows#</cfif>" class="cfDefault">
		&lt;&lt; FIRST</a>

<cfif StartRowBack GT 0>
	<a href="#CGI.SCRIPT_NAME#?StartRow=#StartRowBack#&SortOption=#SortOption#&SortAscending=#SortAscending#<cfif isDefined('field')>&field=#field#&string=#string#</cfif><cfif isDefined('URL.CatDisplay')>&CatDisplay=#CatDisplay#<cfelseif isDefined('URL.SecDisplay')>&SecDisplay=#SecDisplay#</cfif><cfif isDefined('URL.CatFilter')>&CatFilter=#CatFilter#<cfelseif isDefined('URL.SecFilter')>&SecFilter=#SecFilter#</cfif><cfif isDefined('SMC') AND SMC NEQ ''>&SMC=#URLEncodedFormat(SMC)#<cfelseif isDefined('SMS') AND SMS NEQ ''>&SMS=#URLEncodedFormat(SMS)#</cfif><cfif isDefined('URL.ShowRows')>&ShowRows=#URL.ShowRows#</cfif>" class="cfDefault">
		&lt; PREV &lt;</a>
</cfif>
...
--->
<!---
<img src="images/iconnav-backall.gif" alt="First #RowsPerPage# Records" border="0">
<img src="images/iconnav-back1.gif" alt="Previous #RowsPerPage# Records" border="0">
<img src="images/iconnav-next1.gif" alt="Next #RowsPerPage# Records" border="0">
<img src="images/iconnav-nextall.gif" alt="Last #RowsPerPage# Records" border="0">
--->