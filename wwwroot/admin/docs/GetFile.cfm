...
<cfoutput>
<cfloop query="getQBOrders">
		
	<!--- BEGIN: LOOP ORDERED ITEMS HERE --->
	<cfquery name="getQBOrderItems" datasource="#application.dsn#">
		SELECT	p.SKU AS ItemCode, 
				...
				WHERE	oi.OrderID = #PONumber#
				AND		oi.ItemID = p.ItemID
	</cfquery>
	
	<cfloop query="getQBOrderItems">
