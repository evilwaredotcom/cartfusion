...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>	
		...
		<cfif FormOfPayment EQ 1 >
		<td>Exp. Date:</td>
		<td>XX/#Right(decrypted_CCexpdate,2)#</td>
		</cfif>
	</tr>
	<tr>	
		<td>State:</td>
...
<!--- TOTALS ---------------------------------------------------------------------->
	...
	<cfif isDefined('URL.DiscountToApply') AND URL.DiscountToApply GT 0>
		<cfif URL.DiscountToApply GTE 10 >
			<cfset FormattedDiscount = DecimalFormat(('0.' & URL.DiscountToApply) * RunningTotal) >
		<cfelse>
			<cfset FormattedDiscount = DecimalFormat(('0.0' & URL.DiscountToApply) * RunningTotal) >
		</cfif>
	<tr>
		<td colspan="6" height="20">&nbsp;</td>
		<td align="right" class="cfAdminError">#URL.DiscountToApply#% Discount:</td>
	...
	<cfif isDefined('URL.CreditApplied') AND URL.CreditApplied GT 0>HEY
		<cfif URL.CreditApplied GT RunningTotal>
			<cfset URL.CreditApplied = RunningTotal>
			<script>
	...
	<tr>
		...
		<td align="right" class="cfAdminError">#LSCurrencyFormat(Replace(URL.CreditApplied,',',''), "local")#</td>
	</tr>
	<cfset RunningTotal = RunningTotal - Replace(URL.CreditApplied,',','') >
	</cfif>
	<tr>
