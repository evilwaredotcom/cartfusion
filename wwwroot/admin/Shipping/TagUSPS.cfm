...
<cfparam name="ATTRIBUTES.PackageType" default="none"> <!--- see Table T-1 in documentation for list of options --->
...
<cfswitch expression="#ATTRIBUTES.function#">
 ...
 <cfcase value="RateDomesticRequest">
	...
	<RateRequest USERID="#ATTRIBUTES.USPSUserID#" PASSWORD="#ATTRIBUTES.USPSPassword#">
	...
	<cfhttp method="post" url="#ATTRIBUTES.USPSServer#" resolveurl="yes" port="80" timeout="#ATTRIBUTES.TimeOut#">
		<cfhttpparam name="XML" type="xml" value="API=Rate&XML=#ATTRIBUTES.XMLRequestInput#">
	</cfhttp>
	...
	<cfif IsDefined("CALLER.stUSPSRateDomestic.RATERESPONSE.PACKAGE.POSTAGE.XmlText")> <!--- Successful register response --->
		...
		<cfif StructKeyExists(CALLER.stUSPSRateDomestic.RateResponse.Package, "Postage")>	
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "FreightCharges", CALLER.stUSPSRateDomestic.RateResponse.Package.Postage.XmlText)>
		<cfelse>
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "FreightCharges", "0")>
		</cfif>
		<cfif StructKeyExists(CALLER.stUSPSRateDomestic.RateResponse.Package, "Pounds")>	
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "Pounds", CALLER.stUSPSRateDomestic.RateResponse.Package.Pounds.XmlText)>
		<cfelse>
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "Pounds", "")>
		</cfif>
		<cfif StructKeyExists(CALLER.stUSPSRateDomestic.RateResponse.Package, "Ounces")>	
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "Ounces", CALLER.stUSPSRateDomestic.RateResponse.Package.Ounces.XmlText)>
		<cfelse>
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "Ounces", "")>
		</cfif>
		<cfif StructKeyExists(CALLER.stUSPSRateDomestic.RateResponse.Package, "Size")>	
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "Size", CALLER.stUSPSRateDomestic.RateResponse.Package.Size.XmlText)>
		<cfelse>
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "Size", "")>
		</cfif>
		<cfif StructKeyExists(CALLER.stUSPSRateDomestic.RateResponse.Package, "Service")>	
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "Service", CALLER.stUSPSRateDomestic.RateResponse.Package.Service.XmlText)>
		<cfelse>
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "Service", "")>
		</cfif>
		<cfif StructKeyExists(CALLER.stUSPSRateDomestic.RateResponse.Package, "ZipDestination")>	
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "ZipDestination", CALLER.stUSPSRateDomestic.RateResponse.Package.ZipDestination.XmlText)>
		<cfelse>
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "ZipDestination", "")>
		</cfif>
		<cfif StructKeyExists(CALLER.stUSPSRateDomestic.RateResponse.Package, "ZipOrigination")>	
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "ZipOrigin", CALLER.stUSPSRateDomestic.RateResponse.Package.ZipOrigination.XmlText)>
		<cfelse>
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "ZipOrigin", "")>
		</cfif>
		<cfif StructKeyExists(CALLER.stUSPSRateDomestic.RateResponse.Package, "Zone")>	
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "Zone", CALLER.stUSPSRateDomestic.RateResponse.Package.Zone.XmlText)>
		<cfelse>
			<cfset temp = QuerySetCell(CALLER.USPSDomesticRateQuery, "Zone", "")>
		</cfif>
	<cfelseif IsDefined("CALLER.stUSPSRateDomestic.RATERESPONSE.PACKAGE.Error.Description.XmlText")>
		<cfset CALLER.USPSError = 1>
		<cfset CALLER.USPSErrorDesc = CALLER.stUSPSRateDomestic.RATERESPONSE.PACKAGE.Error.Description.XmlText>
	<cfelse>
		<cfset CALLER.USPSError = 2>
		<cfif IsDefined("CALLER.stUSPSRateDomestic.RATERESPONSE.PACKAGE.Error.Description.XmlText")>
			<cfset CALLER.USPSErrorDesc = CALLER.stUSPSRateDomestic.RATERESPONSE.PACKAGE.Error.Description.XmlText>
		</cfif>
	</cfif>
