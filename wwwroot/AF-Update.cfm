...
<cfscript>
	...
	// Decrypt Password
	Decrypted_Password = DECRYPT(getAffiliate.Password, application.siteConfig.data.CryptKey, "CFMX_COMPAT", "Hex") ;
</cfscript>


<cfmodule template="tags/layout.cfm" CurrentTab="Affiliates" PageTitle="Update Affiliate Details" showExpireHeaders="True">
...
<cfform action="#CGI.SCRIPT_NAME#" method="post" preservedata="yes" class="f-wrap-1">
...
<div align="center">
	<hr class="snip" />
	<br />
	<a href="AF-Main.cfm?show4=1"><img src="images/button-Back.gif"></a>&nbsp;&nbsp;
	<a href="AF-Main.cfm?show4=1"><img src="images/button-Home.gif"></a>	
</div>
