...
<cfmodule template="templates/#application.SiteTemplate#/layout.cfm" currenttab="CustomerService" pagetitle="Store Help">
<!--- Start Breadcrumb --->
	...
	<table border="0" cellpadding="0" width="100%" cellspacing="0">
		<tr>
			<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td width="100%" class="help"><a name="HOW TO PLACE YOUR ORDER"><b>HOW TO PLACE YOUR ORDER</b></a>
							</th>
					</tr>
					<tr>
						<td width="100%" class="cfDefault" style="padding-left:10px;padding-right:10px;padding-top:10px;"> Our How-to-Order guide will tell you everything you need to know to place an order on <a href="#application.RootURL#">#application.DomainName#</a> . . . it's easy and completely secure and if you get stuck simply call up customer service at <b>#application.CompanyPhone#</b> and we will assist you with your order. </td>
					</tr>
					<tr>
						...
						<td width="100%" class="cfDefault" style="padding-left:10px;padding-right:10px;padding-top:10px;">
							<ul>
								...
								<li>This Item of choice will be displayed in your shopping bag. You are free to remove 
									...
									you have not purchased these items. Click on the <b>CONTINUE SHOPPING</b> button to resume shopping.</li>
							</ul>
							<p align="center"><a href="##Top">Back to Top</a></p></td>
					</tr>
					<tr>
					...
					<tr>
						<td width="100%" class="cfDefault" style="padding-left:10px;padding-right:10px;padding-top:10px;"> On completion of reviewing your selected item details,
							<ul>
								...
								<li>You will now be take to view the contents of your shopping bag. Should you wish to continue shopping, simply click on the <b>CONTINUE SHOPPING</b> button.</li>
						...
						<td width="100%" class="cfDefault" style="padding-left:10px;padding-right:10px;padding-top:10px;">
							<ul>
								...
								<li>To check on you order status you can either go to your shipment confirmation email and
									...
									customer service department at #application.CompanyPhone# and we will be happy to assist you.</li>
							</ul>
					...
					<tr>
						<td width="100%" class="cfDefault" style="padding-left:10px;padding-right:10px;padding-top:10px;">
							...
							<p>Call Us: #application.CompanyPhone#<br>
							<p>Customer Service Hours: Monday - Friday, 9am - 6pm</p></td>
					</tr>
					<tr>
						<td width="100%"><br>
