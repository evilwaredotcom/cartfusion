...
<cfcomponent displayname="Customer Module">
		...
		<cftry>
			...
			<cfelse>
				...
				<cfelseif GetEmail.RecordCount NEQ 0 >
					<cfscript>
						stReturn.bSuccess = False ;
						stReturn.Message = "Your email address has already been setup in a Barket customer profile.  Please use the username/password retreival feature to sign in." ;
					</cfscript>
				<cfelse>		
					<!--- CREATE CUSTOMERID --->
					<cfscript>
					...
					<cfscript>
						...
						session[application.SessionVar].Customers_BarketBucks = "0.00" ;
				...
				<cfscript>
					...
					else
					{
						...
						else
						{
							...
							session[application.SessionVar].Customers_BarketBucks = "#data.Customers_BarketBucks#" ;
