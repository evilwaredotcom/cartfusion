<cfcomponent>
	<cffunction name="Init" roles="Admin,User">
	...
	<cffunction name="AddUser" roles="Admin,User">
	...
	<cffunction name="EditUser" roles="Admin,User">
	...
	<cffunction name="DeleteUser" roles="Admin">
	...
	<cffunction name="ViewAllUsers" roles="Admin">
